...
func (in *ServiceInitParameters) DeepCopyInto(out *ServiceInitParameters) {
	*out = *in
	...
	if in.LiveTrace != nil {
		...
		*out = make([]LiveTraceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ServiceObservation) DeepCopyInto(out *ServiceObservation) {
	*out = *in
	...
	if in.LiveTrace != nil {
		in, out := &in.LiveTrace, &out.LiveTrace
		*out = make([]LiveTraceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *SignalrSharedPrivateLinkResourceInitParameters) DeepCopy() *SignalrSharedPrivateLinkResourceInitParameters {
	...
	out := new(SignalrSharedPrivateLinkResourceInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WebPubsubInitParameters) DeepCopyInto(out *WebPubsubInitParameters) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]WebPubsubIdentityInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LiveTrace != nil {
		in, out := &in.LiveTrace, &out.LiveTrace
		*out = make([]WebPubsubLiveTraceInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WebPubsubNetworkACLInitParameters) DeepCopyInto(out *WebPubsubNetworkACLInitParameters) {
	*out = *in
	...
	if in.PublicNetwork != nil {
		in, out := &in.PublicNetwork, &out.PublicNetwork
		*out = make([]WebPubsubNetworkACLPublicNetworkInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WebPubsubNetworkACLObservation) DeepCopyInto(out *WebPubsubNetworkACLObservation) {
	*out = *in
	...
	if in.PublicNetwork != nil {
		in, out := &in.PublicNetwork, &out.PublicNetwork
		*out = make([]WebPubsubNetworkACLPublicNetworkObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WebPubsubObservation) DeepCopyInto(out *WebPubsubObservation) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]WebPubsubIdentityObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.LiveTrace != nil {
		in, out := &in.LiveTrace, &out.LiveTrace
		*out = make([]WebPubsubLiveTraceObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *WebPubsubParameters) DeepCopyInto(out *WebPubsubParameters) {
	*out = *in
	...
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = make([]WebPubsubIdentityParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
